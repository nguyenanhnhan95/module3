            ...
            <form method="post" action="/CustomerServlet?action=edit">
                <fieldset >
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" id="name" class="form-control" placeholder="${customer.getName()}">
                    </div>
                    <div class="mb-3">
                        <label for="email" class="form-label">Email :</label>
                        <input type="email" id="email" class="form-control" placeholder="${customer.getEmail()}">
                    </div>
                    <div class="mb-3">
                        <label for="phone" class="form-label">Phone :</label>
                        <input type="text" id="phone" class="form-control" placeholder="${customer.getPhone()}">
                    </div>
                    <div class="mb-3">
                        <label for="address" class="form-label">Address :</label>
                        <input type="text" id="address" class="form-control" placeholder="${customer.getAddress()}">
                    </div>
